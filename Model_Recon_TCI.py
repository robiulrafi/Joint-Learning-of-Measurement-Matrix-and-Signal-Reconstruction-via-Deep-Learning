...
Training_Image_label=sio.loadmat('C:\\RAFI_SHARED\\CS_Classification\\Train_Labels.mat')['Labels']
Testing_Image=sio.loadmat('C:\\RAFI_SHARED\\CS_NET\\GAN\\validation_Image_Label.mat')['X_out']
Testing_Image_label=sio.loadmat('C:\\RAFI_SHARED\\CS_Classification\\Test_Labels.mat')['Labels']
...
Training_Image_label=np.reshape(Training_Image_label,(Training_Image.shape[0],1))
Testing_Image_label=np.reshape(Testing_Image_label,(Testing_Image.shape[0],1))

X_train=Training_Image
Y_train=Training_Image_label
X_test=Testing_Image
Y_test=Testing_Image_label
idx=np.random.randint(50000,size=50000)
P=idx[:40000]
Q=idx[40000:]
TI=Training_Image[P,:]
TI_Label=Training_Image_label[P,:]
VI=Training_Image[Q,:]
VI_Label=Training_Image_label[Q,:]
X_train=TI
Y_train=TI_Label
X_val=VI
Y_val=VI_Label
